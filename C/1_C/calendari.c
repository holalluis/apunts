...
int main(){
  ...
  //time obtiene el tiempo del sistema y se lo pasa a la direccion de sisTime.
  time(&sisTime);
  ...
  while(seleccion != 0){
    ...
    //imprimir dias correspondientes al mes.
    ...
    printf("\n\nDesea Buscar otra Fecha? \t1=SI 0=NO\t>>> ");
    scanf("%d",&seleccion);
